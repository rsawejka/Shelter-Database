...
if ($numRows === 0){
    include "includes/createPersonCompFoster.php";
    ...
    if (isset($_POST['continue'])){
        header('Location: sendToFosterReview.php?animalId=' . $animalId . '&firstName=' . $firstName . '&lastName=' . $lastName . '&personId=' . $personId);
    }
}
