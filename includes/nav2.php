...
if($userRole === "admin"){
    ...
    echo "<div class='accordion accordion-flush adminBar textF8F4E3 border-black' id=''>
    <div class='accordion-item adminBar textF8F4E3'>
        ...
        <div id='flush-collapseOne' class='accordion-collapse collapse' aria-labelledby='flush-headingOne'data-bs-parent='#accordionFlushExample'>
            <div class='accordion-body'> <div><a href='#' class='text-black text-decoration-none'><div class='p-2 textF8F4E3 actionHoverMain'>next link</div></a></div></div>
        </div>
    </div>
</div>";
...
if (isset($_SESSION['users']) && $_SESSION['users']) {
    echo '<div id="logInfo" class="textF8F4E3">User: ' . $_SESSION['users']['email'] .
        '</div>';
    $userRole = $_SESSION['users']['role'];

    echo "<div class='text-white'>(<a href='index.php?logout' class='actionHoverMain textF8F4E3'> Logout </a>)</div>";
    echo "</div>";
}
